...
async function sendToFreshNumber() {
  const targetPhone = '9004876787';
  const templateName = 'universal_b2b_web_v2';
  const params = ['Pink Octopus Studio', '4.8★', 'Bandra West', 'interior designers'];

  console.log('================================================================================');
  console.log(`🎯 DISPATCHING TO FRESH NUMBER: +91${targetPhone}`);
